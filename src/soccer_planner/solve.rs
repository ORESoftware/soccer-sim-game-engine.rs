...
use des_engine::des::animation::frame_recorder::{FrameRecorder, FrameRecorderOpts};
use des_engine::des::animation::html_player::{build_html_set, AnimationSetOptions, AnimationVariant};
use des_engine::des::animation::scenes::soccer_ipmip_solver_scene as solver_scene;
use des_engine::des::animation::scenes::soccer_scene as pitch_scene;
use des_engine::des::animation::types::Animation;
use des_engine::des::general::ip_mip_des::TraceAction;
use crate::soccer_rotation::{
...
pub fn build_problem_from_request(req: &PlannerRequest) -> Result<SoccerProblem, String> {
    ...
    let fieldable_count = req
        ...
        .filter(|p| {
            ...
            !matches!(
                s,
                crate::soccer_rotation::PlayerStatus::Awol
                    | crate::soccer_rotation::PlayerStatus::Injured
            )
        })
        .count();
    ...
    let position_names = crate::soccer_rotation::formation_position_names(&formation);
    ...
    for pl in &req.players {
        ...
        if !matches!(
            player_status[pl.id],
            crate::soccer_rotation::PlayerStatus::Available
                | crate::soccer_rotation::PlayerStatus::Guest
...
fn to_scene_solution(
    mip: &des_engine::des::general::ip_mip_des::IPMIPSolution,
...
mod tests {
    ...
    use des_engine::des::animation::types::Shape;
    use des_engine::des::general::ip_mip_des::validate_ipmip_problem;
    use crate::soccer_rotation::build_soccer_ipmip;
    use crate::soccer_planner::{default_planner_request, PlannerPlayer, PlannerRequest};
